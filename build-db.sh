...
executeMySQLStatement "$MYSQL_CONTAINER_NAME" "DROP DATABASE IF EXISTS barbaq;"
echo "[ OK ] Base de dades eliminada."

echo "[ INFO ] Creant la base de dades..."
executeMySQLStatement "$MYSQL_CONTAINER_NAME" "CREATE DATABASE barbaq;"
executeMySQLStatement "$MYSQL_CONTAINER_NAME" "GRANT ALL PRIVILEGES ON barbaq.* TO 'sail'@'%';"
